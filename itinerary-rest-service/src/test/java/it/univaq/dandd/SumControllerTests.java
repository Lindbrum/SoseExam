...
public class SumControllerTests {
    ...
    void should_return_8_plus_4_answer() {
        Itineraryinfo sum = restTemplate.getForObject("http://localhost:" + randomServerPort + "/sum?arg1=8&arg2=4", Itineraryinfo.class);
    ...
    void should_return_0_plus_4_answer() {
        Itineraryinfo sum = restTemplate.getForObject("http://localhost:" + randomServerPort + "/sum?arg2=4", Itineraryinfo.class);
    ...
    void should_return_8_plus_0_answer() {
        Itineraryinfo sum = restTemplate.getForObject("http://localhost:" + randomServerPort + "/sum?arg1=8", Itineraryinfo.class);
